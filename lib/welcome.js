...
module.exports.welcome = async(iswel, isleft, juna, anu) =>{
	try {
            ...
            for (let num of participants) {
  		      const fkontaku = { key: {participant: `0@s.whatsapp.net`, ...(anu.id ? { remoteJid: `6281211405561-6287880685037@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': ``, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;,;;;\nFN:,\nitem1.TEL;waid=${num.split('@')[0]}:${num.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': setting.pathimg, thumbnail: setting.pathimg,sendEphemeral: true}}}
                try {
    ...
    var wc = await getBuffer(`https://telegra.ph/file/ff68e7241e490b1ce305e.jpg`)
                	await juna.sendMessage(anu.id, {image: wc, caption: `Selamat Datang @${num.split("@")[0]}💐 Selamat Bergabung di Grup 🤝\n\n Saya *MBE-Bot*, Siap membantu anda, Silahkan anda ketik *[ .MENU ]* untuk melihat infomasi.`, mentions: [num]}, {quoted:fkontaku})
                }
   ...
   var lf = await getBuffer(`https://telegra.ph/file/f0f6c302f9b5011013fba.png`) 
await juna.sendMessage(anu.id, {image: lf, caption: `Selamat Tinggal @${num.split("@")[0]}✋ & Sampai berjumpa kembali di Grup ini 🤖`, mentions: [num]}, {quoted:fkontaku})
                        } 
